...
from ata_pipeline1.helpers.re import PATTERN_DATE_YMD, PATTERN_PAGINATION, PATTERN_SLUG
...
COMPONENT_ZERO = SitePageClassifierComponent(
    ...
    about_us=rf"^/(about\-us|awards|our\-team|guest\-contributors|ethics|board\-and\-advisors|impact|team/{PATTERN_SLUG})/?$",
    newsletter=r"^/newsletter/?$",
    donation=r"^/donate/?$",
    article=rf"^/{PATTERN_DATE_YMD}/{PATTERN_SLUG}/?$",
